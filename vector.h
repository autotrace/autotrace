...
extern at_real_coord Vadd_point
  (const at_real_coord, const vector_type);

#define Psubtract_vector Vsubtract_point
extern at_real_coord Vsubtract_point
  (const at_real_coord, const vector_type);

/* This returns the rounded sum.  */
#define IPadd_vector Vadd_int_point
extern at_coord Vadd_int_point
  (const at_coord, const vector_type);
...
extern vector_type Psubtract
  (const at_real_coord, const at_real_coord);
...
extern at_coord IPsubtractP
  (const at_coord, const at_coord);
extern at_coord IPadd
  (const at_coord, const at_coord);
