 ...
 * SPDX-FileCopyrightText: © 2000-2004 Masatake YAMATO
...
#define at_doc__despeckle_level N_("despeckle-level <unsigned>: 0..20; default is no despeckling. ")
  unsigned despeckle_level;

#define at_doc__despeckle_tightness N_("despeckle-tightness <real>: 0.0..8.0; default is 2.0. ")
  gfloat despeckle_tightness;

#define at_doc__noise_removal N_("noise-removal <real>: 1.0..0.0; default is 0.99. ")
...
typedef void (*at_msg_func)(const gchar *msg, at_msg_type msg_type, gpointer client_data);
